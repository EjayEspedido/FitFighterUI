...
export default function EndScreenFoF() {
  ...
  // new fields (fall back to 0)
  const foesHit = Number(result?.foesHit ?? 0);
  const friendsHit = Number(result?.friendsHit ?? 0);
  ...
  return (
    <div className="page start-page" style={{ padding: 14 }}>
      <h1 className="title">Friend or Foe Mode — Final</h1>
      ...
      <div className="start-card" style={{ padding: 12 }}>
        ...
        {/* NEW: Friends/Foes breakdown */}
        <section className="section" style={{ marginTop: 8 }}>
          <label className="section__label">Session Hits</label>
          <div
            style={{
              display: "grid",
              gridTemplateColumns: "repeat(4, 1fr)",
          ...
          >
            <div className="btn small">
              <div style={{ fontSize: 11, opacity: 0.85 }}>Friends Hit</div>
              <div style={{ fontWeight: 900, marginTop: 6 }}>{friendsHit}</div>
            </div>
            <div className="btn small">
              <div style={{ fontSize: 11, opacity: 0.85 }}>Foes Hit</div>
              <div style={{ fontWeight: 900, marginTop: 6 }}>{foesHit}</div>
            </div>
            <div
              style={{
                gridColumn: "span 2",
            ...
            >
              ...
              <div style={{ fontWeight: 700, marginTop: 6 }}>
                ...
                Higher Friends Hit = good. More Foes Hit = check
                accuracy/penalties.
              </div>
            </div>
          </div>
